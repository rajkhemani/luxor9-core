var __dsPreview = (() => {
  ...
  // .design-sync/previews/AuditReportCard.tsx
  var AuditReportCard_exports = {};
  __export(AuditReportCard_exports, {
  ...
  var base = { id: "aud_1", target: "luxor9-core/api", timestamp: Date.parse("2026-06-19T14:32:00Z") };
  function CriticalFindings() {
    const report = {
      ...base,
      score: 62,
      summary: "Surface scan of the orchestration API found 4 issues across auth, CORS, and rate-limiting. Two require attention before the next deploy.",
      findings: [
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dark", style: { background: "#050505", padding: 24 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.AuditReportCard, { report }) });
  }
  function HealthyPass() {
    const report = {
      ...base,
  ...
  return __toCommonJS(AuditReportCard_exports);
})();
